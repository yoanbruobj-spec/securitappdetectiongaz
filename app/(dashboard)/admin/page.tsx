    ...
    return (
      <div className="min-h-screen lg:flex bg-gradient-to-br from-gray-50 via-white to-gray-50">
        ...
        <div className="min-h-screen lg:flex-1 flex flex-col overflow-hidden">
          <header className="bg-white/80 backdrop-blur-sm border-b border-gray-200 px-3 sm:px-4 lg:px-8 py-2 sm:py-3 lg:py-6 sticky top-0 z-30 mt-16 lg:mt-0">
            <div className="h-6 sm:h-8 w-40 sm:w-48 bg-gray-200 rounded animate-pulse mb-1" />
    ...
    <div className="min-h-screen lg:flex relative overflow-hidden">
      ...
      <div className="min-h-screen lg:flex-1 flex flex-col overflow-hidden">
        ...
        <header className="glass-strong border-b border-white/20 px-3 sm:px-4 lg:px-8 py-2 sm:py-3 lg:py-6 sticky top-0 z-20 shadow-lg mt-16 lg:mt-0">
          ...
          >
            <div>
              <h1 className="text-base sm:text-2xl lg:text-4xl font-black text-gradient drop-shadow-lg">
                Tableau de bord
              </h1>
