...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen flex bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      ...
      <div className="flex-1 flex flex-col overflow-hidden lg:ml-0">
        {/* Header */}
        <header className="bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm border-b border-gray-200 dark:border-gray-700 px-4 sm:px-6 lg:px-8 py-4 sm:py-6 sticky top-0 z-30 ml-0 lg:ml-0">
          <motion.div
          ...
          >
            ...
            <div className="hidden sm:flex items-center gap-3 text-sm text-gray-600 dark:text-gray-400 bg-white dark:bg-gray-800 px-4 py-2 rounded-xl shadow-sm ring-1 ring-gray-200 dark:ring-gray-700">
        ...
        <main className="flex-1 overflow-y-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-10">
          {/* Stats Cards - Nouveau design avec QuickStat */}
          ...
          {stockAlertes.length > 0 && (
            <div className="mb-8 sm:mb-10 lg:mb-12">
              <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 sm:p-8 shadow-xl ring-2 ring-red-500/20 dark:ring-red-500/30">
                {/* Header avec badge d'alerte */}
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 pb-6 border-b-2 border-red-100 dark:border-red-900/50">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="flex items-center gap-3 mb-1">
                        ...
                        <span className="px-3 py-1 bg-red-100 dark:bg-red-900/50 text-red-700 dark:text-red-400 text-sm font-bold rounded-full">
                          {stockAlertes.length}
                        </span>
                      </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 lg:gap-6">
                  {stockAlertes.slice(0, 6).map((article, index) => (
                    <motion.div
                      ...
                      className="cursor-pointer bg-gradient-to-br from-red-50 to-orange-50 dark:from-red-900/20 dark:to-orange-900/20 rounded-xl p-6 border-2 border-red-200 dark:border-red-800 hover:border-red-400 dark:hover:border-red-600 hover:shadow-lg transition-all duration-200 group"
                    >
                      <div className="flex items-center gap-4 mb-5">
                        ...
                        <div className="flex-1 min-w-0">
                          <h4 className="font-bold text-base text-gray-900 dark:text-gray-100 mb-0.5 truncate group-hover:text-red-600 dark:group-hover:text-red-400 transition">
                            {article.nom}
                          </h4>
                      ...
                      <div className="flex items-center justify-between bg-white dark:bg-gray-800 rounded-lg p-3 border border-red-200 dark:border-red-800">
                        <div>
                          <p className="text-xs text-gray-600 dark:text-gray-400 mb-1">Stock actuel</p>
                          <div className="flex items-baseline gap-2">
                            <span className="text-3xl font-bold text-red-600 dark:text-red-400">{article.quantite}</span>
                            <span className="text-lg text-gray-400 dark:text-gray-500">/ {article.seuil_alerte}</span>
                          </div>
                        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="lg:col-span-2 order-2 lg:order-1">
              <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 sm:p-8 shadow-lg ring-1 ring-gray-200 dark:ring-gray-700">
                <div className="flex items-center justify-between mb-6">
                  ...
                  <button
                    onClick={() => router.push('/interventions')}
                    className="text-sm text-emerald-600 dark:text-emerald-400 hover:text-emerald-700 dark:hover:text-emerald-300 font-semibold flex items-center gap-1 transition group"
                  >
                    Tout voir
